...
/**
 * JoinSphereUI - Presentation Layer
 *
 * PURPOSE: Display-only component, zero business logic
 *
 * RECEIVES:
 *   - step: Current UI step
 *   - gameCode: User input
 *   - registerData: Form data
 *   - error: Error message
 *   - loading: Loading state
 *   - sphere: Fetched sphere data
 *   - joinedSphere: Sphere after join
 *
 * HANDLERS (from parent):
 *   - onCodeSubmit: Form submission
 *   - onRegisterAndJoin: Registration submit
 *
 * NO:
 *   - API calls
 *   - State management
...
export default function JoinSphereUI({
  step,
  setStep,
  gameCode,
  setGameCode,
  ...
  // Early return states (unchanged from original)
  const isLinkJoin = false;
