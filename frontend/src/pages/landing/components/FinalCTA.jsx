...
{`
  .uiverse-btn-2x {
    ...
    cursor: pointer;
    border: solid 3px #1a1a1a; /* slightly thinner border */
    letter-spacing: 1px;
    font-weight: 700;
    font-size: 28px; /* smaller text */
    background-color: #FFFDD0;
    border-radius: 60px; /* smaller curve */
    position: relative;
    overflow: hidden;
    transition: all 0.4s ease;
    box-shadow: 0px 8px 12px -3px rgba(255, 253, 208, 0.25);
  ...
  .uiverse-btn-2x:hover svg {
    transform: scale(2.4) translate(70%); /* reduced hover explosion */
  }
